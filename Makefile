...
# then proceed with the recommendations
	python rep-learning/scripts/recommendation.py -T league/pickles/X -Y league/pickles/champions_winners -M league/pickles/C9\ Sneaky_relevant_stats_wins -C ../../Desktop/AP_PCA_3d_compressed -o league/results/whatever -op league/pickles/whatever -P rep-learning/pickles/PCA_relevant_stats_winners_3d_projection

recommendationSystemJayJ:
# then proceed with the recommendations
	python rep-learning/scripts/recommendation.py -T league/pickles/X -Y league/pickles/champions_winners -M league/pickles/JayJ_relevant_stats_wins -C ../../Desktop/AP_PCA_3d_compressed -o league/results/whatever -op league/pickles/whatever -P rep-learning/pickles/PCA_relevant_stats_winners_3d_projection

recommendationSystemJungleGuy:
# then proceed with the recommendations
	python rep-learning/scripts/recommendation.py -T league/pickles/X -Y league/pickles/champions_winners -M league/pickles/jungle\ is\ succes_relevant_stats_wins -C ../../Desktop/AP_PCA_3d_compressed -o league/results/whatever -op league/pickles/whatever -P rep-learning/pickles/PCA_relevant_stats_winners_3d_projection
